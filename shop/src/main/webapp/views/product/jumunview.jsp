...
<body>
	<section>
	    ...
	    <table id="table1">
			...
			<tr class="h40">
				<td colspan="2">${map.baeday}(${map.yoil}) 도착예정(상품 1개) </td>
			</tr>
	      	<tr>
	        	<td>
	        	...
	        	<td class="pcontent">  
		            <div class="a1">${map.title}</div>
		            <div class="a2">
			            <fmt:formatNumber value="${map.price}"/>원
			            <span id="chg">(할인율:${map.halin}%)</span>
		            </div>
		            <div class="a3">수량:${map.su}개</div>
	        	</td>
			</tr>
